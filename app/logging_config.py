...
def add_context_info(logger: WrappedLogger, logging_method: str, event_dict: EventDict) -> EventDict:
...
def configure_logging(log_filename: str = "application.log") -> None:
    ...
    # Configure handlers
    configure_std_out_handler(root_logger) # console logging
    configure_file_handler(root_logger, log_filename) # file logging
    ...
    structlog.configure(
        processors=[
            ...
            add_context_info,  # request_id/user_id/pod/host
